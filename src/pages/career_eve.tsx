  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">Career Events</h1>
        <p className="text-gray-600 mb-8">Discover all career-related gatherings and opportunities on campus.</p>
          ...
          {events.map((event) => (
            <div key={event.id} className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src={event.Ephoto}
                alt={event.Ename}
                className="w-full h-48 object-cover cursor-pointer" // ✅ added cursor and click
